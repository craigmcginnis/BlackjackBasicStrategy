...
class MockEngine {
  getDecision(_h: EvaluatedHand, _r: RuleSet): Decision { return 'HIT'; }
  evaluateHand(p: any[], d: any): EvaluatedHand { return { total: 12, isSoft: false, isPair: false, dealerUpValue: d.value }; }
}
class MockStrategyDataService extends StrategyDataService {
  // override to avoid needing STRATEGY_DATA
  override getTablesFor(){ return { hard:{ 12:{2:'HIT',3:'STAND',4:'HIT',5:'HIT',6:'HIT',7:'HIT',8:'HIT',9:'HIT',10:'HIT',11:'HIT'} }, soft:{}, pairs:{} } as any; }
  override ruleKey(): string { return 'S17'; }
}
