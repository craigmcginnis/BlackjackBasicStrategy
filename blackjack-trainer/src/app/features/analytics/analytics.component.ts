...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatCardModule, DatePipe, DecimalPipe],
...
export class AnalyticsComponent {
  ...
  constructor(){
    ...
    effect(()=>{ /* placeholder for reactive tie-in */ });
  }
  private recalc(){ this.history.set([...this.storage.loadStats().history]); }
  ...
  reset(){ this.storage.saveStats({ history: [] }); this.recalc(); }
}
