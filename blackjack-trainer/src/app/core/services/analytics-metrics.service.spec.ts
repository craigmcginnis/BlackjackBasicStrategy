...
describe('AnalyticsMetricsService', () => {
  ...
  const history: SessionStatEntry[] = [
    ...
    { ts:2, mode:'drill', correct:0, attempts:1, expected:'STAND', chosen:'HIT', scenario:'H-16-D10', ms:900 },
    { ts:3, mode:'flash', correct:1, attempts:1, expected:'DOUBLE', chosen:'DOUBLE', scenario:'H-11-D6', ms:700 },
    { ts:4, mode:'flash', correct:0, attempts:1, expected:'SPLIT', chosen:'HIT', scenario:'P-8-D10', ms:600 },
    { ts:5, mode:'flash', correct:1, attempts:1, expected:'SPLIT', chosen:'SPLIT', scenario:'P-8-D6', ms:650 },
    { ts:6, mode:'drill', correct:1, attempts:1, expected:'SURRENDER', chosen:'SURRENDER', scenario:'H-16-D11', ms:800 }
  ];
